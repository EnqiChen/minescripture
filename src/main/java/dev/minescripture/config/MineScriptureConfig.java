...
public final class MineScriptureConfig {
    ...
    public static MineScriptureConfig from(ConfigView v, Function<String, String> env) {
        ...
        b.timeoutSuddenMs = v.integer("gloo.timeout_ms_sudden", 15000);
        b.timeoutBackgroundMs = v.integer("gloo.timeout_ms_background", 20000);
    ...
    public static final class Builder {
        ...
        private long timeoutSuddenMs = 15000;
        private long timeoutBackgroundMs = 20000;
